...
const useProductDetail = productId => {
  ...
  if (query.data && query.data.product) {
    console.log(query.data.product.category)
  }

  // const productCategoryQuery = useQuery(categoryQuery, { variables: { id: productId }, skip: !productId })
